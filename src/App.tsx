...
// --- CONFIGURATION ---
const SCRIPT_URL = "https://script.google.com/macros/s/AKfycbwiHueRtF1Kpn1ZpP_PdU_5Q6e4uHmh266VTsEOlyJdz1mR7vL4peQW1wOkC9Yz-Tn-/exec";

const SEVERITY_WEIGHTS = { Fatality: 100, LTI: 75, RWDI: 50, MTC: 30, FAC: 15, PD: 10, NM: 5 };
const SEVERITY_NORM = { Fatality: 1.0, LTI: 0.8, RWDI: 0.6, MTC: 0.4, FAC: 0.2, PD: 0.1, NM: 0.05 };

// HAZARD WEIGHTS
const HAZARD_RISK_W = { low: 1, medium: 2, high: 3 };
const HAZARD_STATUS_W = { submitted: 1.0, accepted: 1.0, reassign: 1.0, followup: 0.5, end: 0.1 };
...
const parseSafeDate = (dateStr) => {
  ...
  if (parts.length >= 3) {
    ...
    if (isNaN(month)) {
      ...
      const months = { jan: 0, feb: 1, mar: 2, apr: 3, may: 4, mei: 4, jun: 5, jul: 6, aug: 7, ags: 7, sep: 8, oct: 9, okt: 9, nov: 10, dec: 11, des: 11 };
